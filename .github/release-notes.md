...
- **Copilot CLI plugin marketplace** — ATV now ships as a marketplace at `.github/plugin/marketplace.json`. Install personally with `copilot plugin marketplace add All-The-Vibes/ATV-StarterKit` then `copilot plugin install atv-starter-kit@atv-starter-kit`. See [docs/marketplace.md](https://github.com/All-The-Vibes/ATV-StarterKit/blob/main/docs/marketplace.md).
